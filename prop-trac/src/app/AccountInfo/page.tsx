    ...
    <div className='block lg:hidden'>
      ...
      <p className='text-3xl lg:text-4xl py-8 ml-10 lg:ml-60'>Account Info</p>
          <div className='w-full lg:w-3/4 mx-auto lg:mx-0 lg:ml-60 flex justify-evenly text-xl'>
            <div className='w-full h-full mx-10 lg:mx-0 bg-white rounded-xl border-black border-2 space-y-8 px-12 xl:pl-16 xl:pr-20 py-10 max-xl:text-sm'>
          ...
          <div className='mx-10 lg:ml-60 mt-4 mb-5 w-[90%] lg:w-3/4 min-h-60 rounded-xl bg-white border-black border-2'>
