...
import { checkToken, getProperties } from "@/Utils/DataService";
        ...
        <div className="ml-52">
          <div className="flex justify-between pt-5 pr-10">
            ...
            <div className="relative w-72 ">
              <input
                type="search"
                className="w-72 h-10 border-0 rounded-xl bg-gray-200 text-sm"
                value={value}
                placeholder="Search Properties"
                onChange={(e) => setValue(e.target.value)}
              />
              <MagnifyingGlass
                className="absolute top-[10px] right-3 opacity-65"
                size={20}
              />
            </div>
          </div>
                      ...
                      <TableRow key={idx}>
                        ...
                        <TableCell>
                          <p
                            ...
                            } w-16 h-7 text-center pt-1`}
                          >
                            {prop.tenantAssigned ? "Booked" : "Vacant"}
                          </p>
                        </TableCell>
                        <TableCell>
                          <a className="underline text-[#4E8AFF] hover:cursor-pointer" onClick={() => router.push('/PropertyInfo')}>
                            Details
                          </a>
                        </TableCell>
                      </TableRow>
